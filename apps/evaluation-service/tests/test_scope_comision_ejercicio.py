...
async def test_docente_ajeno_no_puede_marcar_ejercicio(scope_setup: dict) -> None:
    """PATCH /ejercicio sobre una entrega de otra comision → 403 (era 200)."""
...
async def test_docente_propio_conserva_la_reapertura(scope_setup: dict) -> None:
    """La reapertura docente (2026-06-19) NO recibe 403 en su propia comision.

    Solo se afirma la autorizacion (200, no 403) — que es lo que este guard
