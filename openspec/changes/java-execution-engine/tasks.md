...
- [x] 1.5 🔴 Confirmar cgroups antes de contratar servidor. **N/A mientras sea gestionado** — el kernel es del proveedor. Queda registrado en el ADR (D3) como pre-condición dura para el día que se autoaloje: `isolate` exige **cgroups v1**, las distros modernas traen **v2**, y se comprueba con `stat -fc %T /sys/fs/cgroup/` (`tmpfs` = v1, `cgroup2fs` = v2) **antes de pagar**.
- [x] 1.6 Dimensionar los procesos de trabajo contra la concurrencia real. **Calculado, con los supuestos declarados:**
