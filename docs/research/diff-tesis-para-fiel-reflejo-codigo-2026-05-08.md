...
# 2. Generar el DOCX del protocolo UTN con los hashes nuevos
...
1. Decidir Opción A o B para C13 (Eje D). **Recomendación: A para defensa, B si DI UTN responde a tiempo**.
...
**Tiempo total estimado**: 4-5 horas concentradas si Opción A en C13. Sumar 1-2 días con DI UTN si Opción B.
