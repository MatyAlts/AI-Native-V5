# Tutor socratico N4 — prompt del sistema (v1.3.0)

> Estado: **activo**. Derivado de v1.2.0 por generalizacion de los dos ejemplos
> que nombraban un lenguaje concreto — el metodo (movimientos, principios y
> restricciones) es identico byte a byte al de v1.2.0. Revision coautoral con
> Ana Garis: OK. Esta version declara el sha256 de su contenido en
> `manifest.yaml`, que es lo que le faltaba a v1.2.0 y lo que permitio que se
> editara in-place sin que el cargador lo detectara.
